      ...
      Promise.all([
        ...
        .then(([ questions, materials ]) => {
          this.setState({
            ...
            allMaterials: materials.response.data['@graph'].filter((material) => material.URL !== undefined).map((material) => ({
              ...material,
              new: false
            })),
          });
              ...
              <NavItem>
                <NavLink
                  className={ classnames({
                    ...
                    hasError: !infoOK(this.state.info)
                  }, "clickable") }
                  onClick={ () => {
              ...
              <NavItem>
                <NavLink
                  className={ classnames({
                    ...
                    hasError: !submissionOK(this.state.submission)
                  }, "clickable") }
                  onClick={ () => {
              ...
              <NavItem>
                <NavLink
                  className={ classnames({
                    ...
                    hasError: !fieldsOK(this.state.fields)
                  }, "clickable") }
                  onClick={ () => {
              ...
              <NavItem>
                <NavLink
                  className={ classnames({
                    ...
                    hasError: !teamsOK(this.state.teams)
                  }, "clickable") }
                  onClick={ () => {
              ...
              <NavItem>
                <NavLink
                  className={ classnames({
                    ...
                    hasError: !reviewsOK(this.state.reviews, getRealDeadline(this.state.submission))
                  }, "clickable") }
                  onClick={ () => {
                ...
                !this.state.teams.disabled && <NavItem>
                  <NavLink
                    className={ classnames({
                      ...
                      hasError: !teamReviewsOK(this.state.teams, this.state.teamReviews, getRealDeadline(this.state.submission))
                    }, "clickable") }
                    onClick={ () => {
          ...
          <ModalFooter>
            ...
            <span>
              ...
              <Button color="success" disabled={ !this.canSave() || this.state.saving }
                      onClick={ this.submitAssignment.bind(this) }>{ this.state.saving ? 'Adding assignment' : 'Add assignment' }</Button>
            </span>
          </ModalFooter>
        </Modal>
      </div>
