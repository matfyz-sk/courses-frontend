...
import { getFileType, htmlFixNewLines, unixToString } from 'helperFunctions';
        ...
        if(selectedText.toString().length !== 0) {
          ...
          self.setState({
            ...
            addComment: {
              ...
              }, text: selectedText.toString(), element, lineNumber
            }
          });
        } else {
      ...
      <div>
        <div className="bottomSeparator">
          ...
          <Button
            ...
            onClick={ () => {
              ...
              if(this.state.generalParentComment) {
                ...
                this.setState({
                  generalParentComment: null,
                  generalComments: [ ...this.state.generalComments, newSubcomment ],
                  newGeneralComment: ''
                });
              }
            } }
          ...
          { this.state.openAddComment && this.props.match.params.tabID === "2" &&
            <Popover placement="right" className="bigPopover" isOpen={ this.state.openAddComment } toggle={ () => {
              ...
              <PopoverBody>
                ...
                <FormGroup>
                  ...
                  <Input id="addCodeComment" type="textarea" value={ this.state.newCodeComment }
                         onChange={ (e) => this.setState({newCodeComment: e.target.value}) }/>
                </FormGroup>
                <div className="row">
                  <Button color="danger" className="mr-auto" onClick={ () => {
                    this.setState({openAddComment: false})
                  } }>
                    Close
                  </Button>
                  <Button
                    ...
                    onClick={ () => {
                      ...
                      this.setState({
                        ...
                        addComment: null,
                        newCodeComment: '',
                        allComments: [ ...this.state.allComments, newCodeComment ]
                      })
                    } }
                  >
                    Add comment
          ...
          { this.state.commentsLocation !== null && this.props.match.params.tabID === "2" &&
            <Popover placement="right" className="bigPopover" isOpen={ this.state.commentsLocation !== null }
                     toggle={ () => {
                  ...
                  <div className="comment-section" key={ comment.id }>
                    ...
                    { this.state.addSubcomment === comment.id && <div>
                      <FormGroup>
                        ...
                        <Input id="addCodeSubcomment" type="textarea" value={ this.state.newSubcomment }
                               onChange={ (e) => this.setState({newSubcomment: e.target.value}) }/>
                      </FormGroup>
                      <div className="row">
                        <Button color="danger" className="mr-auto" onClick={ () => {
