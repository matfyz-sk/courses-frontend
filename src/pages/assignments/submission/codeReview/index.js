...
class CodeReviewContainer extends Component {
  ...
  getSortedAllCodeComments() {
    ...
    return this.state.allCodeComments.sort((comment1, comment2) =>
      sortFunction(comment1, comment2)
    )
  }
        ...
        <div className="bottomSeparator">
                  ...
                  onClick={() => {
                    if (file.dir) {
                      ...
                      let name = file.name.substring(
                        this.state.currentFolder.length,
                        file.name.length
                      )
                      if (
          ...
          <CodeReview
            ...
            setForceOpenComment={forceOpenComment =>
              this.setState({ forceOpenComment })
            }
            setForceCloseComment={forceCloseComment =>
              this.setState({ forceCloseComment })
            }
          ...
          {/* <FormGroup>
            ...
            <FormText color="muted">
              ...
              problems ( comments are bind to submission that should have
              unchanged zip file ){' '}
            </FormText>
            <Input
              name="codeReview"
          ...
          <div>
            <div className="row">
              ...
              <Button
                ...
                className="ml-auto"
                onClick={() =>
                  this.setState({ openedComments: !this.state.openedComments })
                }
              >
          ...
          <FormGroup>
            ...
            <Input
              ...
              onChange={e =>
                this.setState({ newGeneralComment: e.target.value })
              }
            />
          </FormGroup>
