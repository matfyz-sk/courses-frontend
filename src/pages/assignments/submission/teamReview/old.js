...
import { Button, Card, CardBody, Collapse, FormText, Label, ListGroup, ListGroupItem } from 'reactstrap';


const students = [ {value: 0, badgesGiven: 10, percentageGiven: 105, label: 'Patricny'}, {
  value: 1,
  badgesGiven: 7,
  percentageGiven: 105,
  label: 'Haradon'
}, {value: 2, badgesGiven: 0, percentageGiven: 90, label: 'Pestrak'} ];
      ...
      <div>
        <div>
          <div>
            ...
            <FormText color="muted">
              Example, if one student will have 50% and another 100%, student one will get third of the points while the
              other the rest.
