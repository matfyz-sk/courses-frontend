...
import { inputToTimestamp } from '../../../helperFunctions';
...
class AssignmentView extends Component{
  ...
  getDefaultOpenState(){
    return this.afterNow(this.props.assignment.initialSubmissionPeriod.deadline) ||
      ( this.props.assignment.submissionImprovedSubmission && this.afterNow(this.props.assignment.improvedSubmissionPeriod.deadline)) ||
      ( !this.props.assignment.reviewsDisabled && this.afterNow(this.props.assignment.peerReviewPeriod.deadline)) ||
      ( !this.props.assignment.teamReviewsDisabled && !this.props.assignment.teamsDisabled && this.afterNow(this.props.assignment.teamReviewPeriod.deadline))||
      ( this.props.isInstructor /* AK je assignment po prvom a aj druhom submissione (ak existuje) nacitat submissions a zistit ktore su neohodnotene */ )
  }
    ...
    return(
      <div className="assignmentViewContainer center-ver">
        ...
        <Collapse isOpen={this.state.opened}>
          <Card>
            <CardBody>
              <div dangerouslySetInnerHTML ={{__html:this.props.assignment.shortDescription}} />
