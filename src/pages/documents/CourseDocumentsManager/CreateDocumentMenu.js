...
import {
    ...
    useAddExternalDocumentMutation, useAddFileMutation, useAddInternalDocumentMutation, useGetFolderQuery,
...
function CreateDocumentMenu({ onFolderCreate, loading, match, history }) {
    ...
    const { data: courseInstanceData, isFetching } = useGetCourseInstanceQuery(courseInstanceFullId, {skip: !courseId  })
